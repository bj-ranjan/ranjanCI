...
<div class="row">
 ...
 ?>
  ...
  <div class="col"><button class="btn btn-primary" title ="Edit" onclick="edit_person($row->user_id)"">Edit</button></div>
...
function edit(){
	...
	//alert (url);
	 ...
	 $.ajax({
        ...
        {
            alert('Error adding / update data');
            $('#btnEdit').text('save'); //change button text
...
<div id="show_modal" class="modal fade" role="dialog" style="background: #000;">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
         <button type="button" class="btn btn-primary"><i class="fa fa-times"></i> Edit</button>
